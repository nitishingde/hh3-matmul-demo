...
#ifndef HH3_MATMUL_OUTPUT_STATE_H
#define HH3_MATMUL_OUTPUT_STATE_H

#include "../data/matrix_block_data.h"

template<class Type, Order Ord>
class OutputState: public hh::State<1,
        MatrixBlockData<Type, 'c', Ord>,    //inp1
        MatrixBlockData<Type, 'c', Ord>     //out1
    > {
private:
    std::vector<size_t>  ttl_ = {};
    size_t gridHeightTTL_ = 0;
    size_t gridWidthTTL_ = 0;
...
#endif //HH3_MATMUL_OUTPUT_STATE_H
