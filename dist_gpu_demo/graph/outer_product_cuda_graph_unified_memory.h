...
#ifndef HH3_MATMUL_OUTER_PRODUCT_CUDA_GRAPH_UM_H
#define HH3_MATMUL_OUTER_PRODUCT_CUDA_GRAPH_UM_H
...
class OuterProductCudaGraphUnifiedMemory:
    public hh::Graph<2,
        MatrixTile<MatrixType, InpIdA, Ord>,      //inp1
        MatrixTile<MatrixType, InpIdB, Ord>,      //inp2
        UnifiedMatrixTile<MatrixType, OutId, Ord> //out1
    > {
public:
    OuterProductCudaGraphUnifiedMemory(uint64_t mTiles, uint64_t kTiles, uint64_t nTiles, uint64_t tileSize, size_t productThreads):
        hh::Graph<2, MatrixTile<MatrixType, InpIdA, Ord>, MatrixTile<MatrixType, InpIdB, Ord>, UnifiedMatrixTile<MatrixType, OutId, Ord>>("GPU Computation Graph") {
        ...
        auto productTask  = std::make_shared<CudaProductTask<
            MatrixType, InpIdA, InpIdB, OutId, Ord,
            CudaMatrixTile<MatrixType, InpIdA, Ord>,
            CudaMatrixTile<MatrixType, InpIdB, Ord>,
            UnifiedMatrixTile<MatrixType, OutId, Ord>
        >>(productThreads);
        ...
        auto unifiedMatrixTilePMemoryManager = std::make_shared<hh::StaticMemoryManager<UnifiedMatrixTile<MatrixType, OutId, Ord>, uint64_t>>(productThreads, tileSize);
        ...
        productTask->connectMemoryManager(unifiedMatrixTilePMemoryManager);
        ...
        this->template output<UnifiedMatrixTile<MatrixType, OutId, Ord>>(productTask);
    }
};

#endif //HH3_MATMUL_OUTER_PRODUCT_CUDA_GRAPH_UM_H
