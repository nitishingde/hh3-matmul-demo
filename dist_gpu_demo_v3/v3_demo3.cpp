...
int main(int argc, char *argv[]) {
    ...
    auto time = strategy.builder(gp, gq, wh, ww, d, l, productThreads, T).executeImpl(matrixA, matrixB, matrixC, deviceIds, mpiComm, path + "window_" + std::to_string(getNodeId()) + ".dot");
    if(isRootNodeId()) {
