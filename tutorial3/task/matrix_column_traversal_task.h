...
class MatrixColumnTraversalTask : public hh::AbstractTask<1, MatrixBlockData<Type, Id, Ord>, MatrixData<Type, Id, Ord>> {
 public:
  MatrixColumnTraversalTask() : hh::AbstractTask<1, MatrixBlockData<Type, Id, Ord>, MatrixData<Type, Id, Ord>>
  ("ColumnTraversal") {}
