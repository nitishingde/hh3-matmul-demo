...
class MatrixRowTraversalTask : public hh::AbstractTask<1, MatrixBlockData<Type, Id, Ord>, MatrixData<Type, Id, Ord>> {
 public:

  MatrixRowTraversalTask() : hh::AbstractTask<1, MatrixBlockData<Type, Id, Ord>,
