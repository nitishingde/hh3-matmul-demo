...
class ProductTask : public hh::AbstractTask<1, std::pair<std::shared_ptr<MatrixBlockData<Type, 'a', Ord>>, std::shared_ptr<MatrixBlockData<Type, 'b', Ord>>>,
...
> {
 ...
 public:
  ProductTask(size_t numberExecutionThread, size_t countPartialComputation)
      : hh::AbstractTask<1, std::pair<std::shared_ptr<MatrixBlockData<Type, 'a', Ord>>, std::shared_ptr<MatrixBlockData<Type, 'b', Ord>>>,
      MatrixBlockData<Type, 'p', Ord>
